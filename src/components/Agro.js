...
import camionCampo from "../img/camionCampo.jpg"
...
const Agro = () => {
    return (
        <div className="m-navbar fondo2 p-1">
            ...
            <h3 className="display-6"><b>Agro</b> </h3>
            <img src={siempreVerde} className="imgNombre mt-2 altura" alt="" />
            </div>  
            <section className="row">
                <div className="col-sm-12 col-md-6 contenedor">
                    <img src={plantacion} className="w-100 imagen" alt="" />            
                </div>
                ...
                <div className="col-sm-12 col-md-6 contenedor">
                    <img src={camionCampo} className="w-100 imagen" alt="" />
                </div>
            </section>
